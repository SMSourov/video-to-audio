...
def process_json_file(json_file_name, original_file, current_millis):
    """
    Function to process the JSON file and extract audio and cover image information
    """
    # List to store audio information
    audio_info_list = []
            ...
            if isinstance(track_info, list):
                ...
                for track in track_info:
                    ...
                    if not first_element_processed:
                        ...
                        # Extract "AudioCount" and convert to int if it's a string
                ...
                # Now process audio based on audio_count
                if audio_count is None or audio_count < 1:
                    ...
                    for track in track_info:
                        ...
                        # Extract typeorder from "@typeorder" or use the current track counter
                ...
                # After processing all tracks, print audio information and extract audio
                if audio_info_list:
